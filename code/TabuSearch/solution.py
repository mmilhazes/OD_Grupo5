...
file = open('./Tabu_Search/ft53.atsp', 'r') # Open txt file. To change the file just change "ft53.atsp" to "kro124p.atsp"
...
matrix_dist=[lista_num[i:i + n_nos] for i in range(0, len(lista_num), n_nos)]

class Solution(object):

    def __init__(self):
        
        self.distance_matrix = np.array(matrix_dist)  # read the distance matrix
        self.number_of_nodes = n_nos  # extract the number of nodes in the system
